      ...
      <b-nav-item @click="logUserOut" active>Logout</b-nav-item>
       ...
       <span slot="activator">
         <p class="grey--text text--darken-2">
           <b class="indigo--text" >{{ user.firstname }}, you have guessed the word: {{guess}}</b>
            
         </p> 

<router-link to="/login?redirect?url=/chat">Now you can share this link to Player 2 to start playing!</router-link>
