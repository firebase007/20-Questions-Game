<template>
 ...
 <section>
     <div class="container" id= "text">
          ...
          <b-card-text>Guess any generic word, for example <b>Animal</b>, Now start playing!!!</b-card-text>
    <div class="row" id= "text">
      <div class="col-lg-6 offset-lg-3 col-sm-10 offset-sm-1">
        ...
        >
          ...
          <center>
            <button large @click="submitGuess" class="btn btn-primary btn-block w-75 my-4">
              Start Game!
            </button>
          </center>
        </form>
